...
runAST :: (MonadInterpreter m, RuntimeASTTag t) => AST p t -> m Value
...
---------- Expressions ----------
evalExpr :: (MonadInterpreter m, RuntimeASTTag t) => AST 'Expr t -> m Value
...
---------- Statements ----------
runStmt :: forall m t. (MonadInterpreter m, RuntimeASTTag t) => AST 'Stmt t -> m Value
...
-- | DataDef
bindTopLevel :: (MonadInterpreter m, RuntimeASTTag t) => AST 'TopLevel t -> m Value
...
runProgram :: (MonadInterpreter m, RuntimeASTTag t) => AST 'Module t -> m ()
