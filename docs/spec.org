...
Function declarations can only be used at the top level. They have the following
form:

#+BEGIN_SRC kima
fun f(a: t1, b: t2, c: t3) -> [eff1, eff2, ...] rt {
    ...statements...
}
#+END_SRC

None of the types here can be omitted as they can in anonymous local functions.
